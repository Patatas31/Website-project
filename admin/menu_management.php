...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $image_path)) {
            ...
            $query = "INSERT INTO menu (item_name, price, description, image_path) VALUES ('$item_name', '$price', '$description', '$image_path')";
        ...
        echo "<div class='message error'>No image uploaded.</div>";
    }
}
...
if (isset($_GET['delete_id'])) {
    ...
    mysqli_query($con, "DELETE FROM menu WHERE id = $delete_id");
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td>
                                <a href='edit_menu.php?edit_id={$row['id']}'>Edit</a> | 
                                <a href='menu_management.php?delete_id={$row['id']}' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                            </td>
                        </tr>";
                }
                ?>
